...
func (o TaggedCertAmdArkAsk) MarshalCBOR() ([]byte, error) {
	return em.Marshal(o)
}

func (o *TaggedCertAmdArkAsk) UnmarshalCBOR(b []byte) error {
	return dm.Unmarshal(b, &o)
}
...
var cryptoKeyValueRegister = map[string]ICryptoKeyFactory{
	...
	CertAmdArkAskType:      NewCertAmdArkAsk,
}
