...
func Test_structFields_CRUD(t *testing.T) {
	sf := newStructFields()
...
func Test_structFields_CBOR_roundtrip(t *testing.T) {
...
func Test_structFields_CBOR_decode_tagged(t *testing.T) {
	data := []byte{
		0xc1, // tag 1
		0xa5, // map 5
		0x00, 0x00,
...
func Test_structFields_CBOR_decode_indefinite(t *testing.T) {
	data := []byte{
		0xbf, // indefinite map
		0x00, 0x00,
		0x01, 0x00,
...
func Test_structFields_CBOR_decode_negative(t *testing.T) {
	dm, err := cbor.DecOptions{}.DecMode()
	require.NoError(t, err)
