...
// structFields is a specialized implementation of "OrderedMap", where the
...
func (o structFields) Has(key int) bool {
	_, ok := o.Fields[key]
	return ok
}

func (o *structFields) Add(key int, val cbor.RawMessage) error {
	if o.Has(key) {
...
func (o *structFields) Get(key int) (cbor.RawMessage, bool) {
	val, ok := o.Fields[key]
	return val, ok
}

func (o *structFields) Delete(key int) {
	delete(o.Fields, key)
...
func (o *structFields) ToCBOR(em cbor.EncMode) ([]byte, error) {
	var out []byte
...
func (o *structFields) FromCBOR(dm cbor.DecMode, data []byte) error {
	if len(data) == 0 {
...
func (o *structFields) unmarshalKeyValue(dm cbor.DecMode, rest []byte) ([]byte, error) {
	var key int
